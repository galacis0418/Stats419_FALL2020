---
title: 'R Notebook: Workspace Audit for [11373111]'
output:
  html_document:
    df_print: paged
    toc: yes
...
```{r}
wsu.id = "Joshua_Bennett"; # change this to yours.
github.repository = "Joshua-Bennett/WSU_STATS419_FALL2020";
...
```{r}
path.to.git.local = "C:/Users/Galac/Desktop/git419/Stats419_FALL2020/";
...
Hey, This is Josh Bennett. I feel I deserve 39/50 points for this section. Mainly being removed due to my lack of pushing to git.
I generally spent around 2 to 2 and a half hours reading a notebook.  I would generally do this all in one sitting due to learning more when
I go through the notebook at one time, along with my children not giving me real time to come back to it later. Basically if they fell asleep I would
finish the whole thing. I also was working on multiple different computers due to my wife living half to time with her parents down in Vancouver, Wa so she
can go to school. I tried to locate all the information needed and move it to this computer so it would be all in one place. 
</pre>
